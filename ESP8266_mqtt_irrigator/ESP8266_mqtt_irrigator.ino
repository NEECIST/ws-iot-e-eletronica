...
#define AP_SSID     "LuisAndrade"
#define AP_PASSWORD "luisandrade"


// Antes de se definir a password e o username é preciso criar conta em:
// https://easyiot-cloud.com
#define EIOTCLOUD_USERNAME "miguel5andrade"
#define EIOTCLOUD_PASSWORD "miguel5miguel"
...
#define IRRIGATION_PAUSE_TIME  0 // Tempo de pausa da irrigação em segundos - só é relevante no modo de automático
  ...
  if (IsTimeout()) // Executa a cada segundo
  {
    ...
    switch (state)
    {
      ...
      case s_irrigation_start:
        irrigatorCounter = 0;
        digitalWrite(PIN_PUMP, LOW); //enviamos LOW para ligar a bomba
        valueStr = String(1);
